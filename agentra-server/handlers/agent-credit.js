...
exports.handleGetCreditBureau = handleGetCreditBureau;
exports.handleGetAgentProfile = handleGetAgentProfile;
exports.handleRegisterAgent = handleRegisterAgent;
exports.handleDrawCredit = handleDrawCredit;
exports.handleVerifyOutcome = handleVerifyOutcome;
exports.handleRepayCredit = handleRepayCredit;
exports.handleGetPoolStats = handleGetPoolStats;
// ════════════════════════════════════════════════════════════════════
// IN-MEMORY DATABASE & SEED DATA
// ════════════════════════════════════════════════════════════════════
const AGENTS_DATABASE = new Map();
const OBLIGATIONS_DATABASE = new Map();
let POOL_STATS = {
...
function calculateCreditScore(metrics) {
    const { repaymentReliabilityRate, verifiedTaskQualityScore, identityContinuityMonths, policyComplianceRate, serviceDiversityCount, } = metrics;
...
// ROUTE HANDLERS
// ════════════════════════════════════════════════════════════════════
async function handleGetCreditBureau(c) {
...
async function handleGetAgentProfile(c) {
...
async function handleRegisterAgent(c) {
    try {
 ...
 */
async function handleDrawCredit(c) {
    try {
        const body = await c.req.json();
 ...
 */
async function handleVerifyOutcome(c) {
    try {
        const body = await c.req.json();
 ...
 */
async function handleRepayCredit(c) {
    try {
        const body = await c.req.json();
...
async function handleGetPoolStats(c) {
    return c.json({
        success: true,
        pool: POOL_STATS,
    });
